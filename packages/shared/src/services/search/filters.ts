...
export class FilterManager {
  ...
  static async getPopularTags(_userId: string, _limit: number = 20): Promise<Array<{ tag: string; count: number }>> {
    try {
  ...
  static async getPopularDomains(_userId: string, _limit: number = 10): Promise<Array<{ domain: string; count: number }>> {
    try {
